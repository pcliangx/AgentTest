...
export function DispatchPicker({
  ...
  return (
    <div
      ...
      aria-modal="true"
      tabIndex={-1}
      className="absolute inset-0 z-30 flex items-center justify-center bg-backdrop"
      onKeyDown={onKeyDown}
    >
      <div
      ...
      >
        ...
        {taskContext && (
          <p className="rounded-lg bg-raised px-2 py-1 text-xs text-ink">
        ...
        {resolved.hasAll && (
          <p className="rounded-lg bg-brand-soft px-2 py-1 text-xs text-brand-ink">
        ...
        <label className="block text-xs text-muted">
          ...
          <textarea
            ...
            className="mt-1 min-h-[3rem] w-full resize-none rounded border border-line bg-paper px-2 py-1 text-sm text-ink placeholder:text-muted"
            value={instruction}
        ...
        {displayedTargetPreviews.length > 0 &&
          ...
          <section
            role="region"
            aria-label="派发预览"
            className="space-y-1 rounded-lg border border-line bg-raised p-2 text-xs text-ink"
          >
            <div>
            ...
            <div>
              <span className="text-muted">指令：</span>
              {displayedInstruction}
            </div>
            <div>
              <span className="text-muted">资源范围：</span>
            ...
            <div
              ...
              aria-busy={planning}
            >
              <span className="text-muted">队列位置：</span>
        ...
        {planError && (
          <div
            role="alert"
            className="flex items-center justify-between gap-2 text-xs text-danger"
          >
            <span>{planError}</span>
            <button
